    ...
    <div class="card-body">
      ...
      >
        ...
        <template v-slot:action="{ row: data }">
          ...
          { label: 'View', type: 'link', target: { name: 'countries-view', params: { id: data.id } } },
          { label: 'Edit', type: 'link', target: { name: 'countries-edit', params: { id: data.id } } },
...
export default defineComponent({
  ...
  setup() {
    ...
    const urlPagination = "/countries/pagination";
