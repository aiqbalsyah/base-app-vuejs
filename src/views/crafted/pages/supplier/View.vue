            ...
            >
              ...
              <div class="d-flex flex-column">
                ...
                <div class="d-flex flex-wrap pe-2">
                  ...
                  >
                    <span class="text-gray-700 fw-bold d-block me-2">Country :</span>
                    <span class="text-gray-900 fw-semibold d-block">{{ record.country?.name }}</span>
                  </div>
                </div>
                <!--end::Info-->
                <!--begin::Info-->
                <div class="d-flex flex-wrap pe-2">
                  <div
                    class="d-flex align-items-center me-5 mb-2"
                  >
                    <span class="text-gray-700 fw-bold d-block me-2">Origin Area :</span>
                    <span class="text-gray-900 fw-semibold d-block">{{ record.originArea?.name }}</span>
                  </div>
                </div>
                <!--end::Info-->
                <!--begin::Info-->
