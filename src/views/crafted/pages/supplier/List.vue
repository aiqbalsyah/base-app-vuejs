  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      >
        ...
        <template v-slot:originArea_name="{ row: data }">
          {{ data.originArea.name }}
        </template>
        ...
        <template v-slot:action="{ row: data  }">
          <div class="text-end">
            <DefaultAction :action-list="[
                { label: 'View', type: 'link', target: { name: 'suppliers-view', params: { id: data.id } } },
                { label: 'Edit', type: 'link', target: { name: 'suppliers-edit', params: { id: data.id } } },
...
export default defineComponent({
  ...
  setup() {
    const tableHeader = ref([
      ...
      {
        columnName: "Origin Area",
        columnLabel: "originArea_name",
        columnWidth: 100,
        sortEnabled: true,
      },
      {
    ...
    const urlPagination = "/suppliers/pagination";
