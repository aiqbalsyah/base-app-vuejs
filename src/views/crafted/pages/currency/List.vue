  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      >
        ...
        <template v-slot:initial="{ row: data }">
          {{ `${data.initial}` }}
        </template>
        ...
        <template v-slot:action="{ row: data }">
            <div class="text-end">
                ...
                { label: 'View', type: 'link', target: { name: 'currencies-view', params: { id: data.id } } },
                { label: 'Edit', type: 'link', target: { name: 'currencies-edit', params: { id: data.id } } },
...
export default defineComponent({
  ...
  setup() {
    ...
    const urlPagination = "/currencies/pagination";
