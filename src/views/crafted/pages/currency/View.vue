  ...
  <div>
    ...
    <div v-else class="card mb-5 mb-xxl-8">
      <div class="card-header">
        <h3 class="card-title">Currency View</h3>
            ...
            >
              ...
              <div class="d-flex flex-column">
                ...
                <div class="d-flex flex-wrap pe-2">
                  ...
                  >
                  <span class="text-gray-700 fw-bold d-block me-2">Symbol :</span>
                  <span class="text-gray-900 fw-semibold d-block">{{ record.initial }}</span>
                  </div>
                </div>
                <!--end::Info-->
                <!--begin::Info-->
...
const getData = async (id) => {
  try {
    ...
    const response = await ApiService.query(`currencies/${id}`, {
